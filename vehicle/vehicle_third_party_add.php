...
<body>
    ...
    <!-- Content -->
        ...
        <div class="content">
            ...
            <form id="add_third_party" method="post">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Add New Third Party Claim</strong>
                            </div>                            
    ...
    $(document).ready(function(){
        ...
        $('#add_third_party').on("submit", function(event){  
            ...
            if($('#runner_name').val() == ""){  
                 ...
                 $.ajax({  
                      ...
                      method:"POST",  
                      data:{action:'add_new_third_party_claim', data: $('#add_third_party').serialize()},  
                      success:function(data){ 
                            if(data){  
                                alert("Added Successfully!");
                                window.location = "vehicle_third_party_claim.php";  
                            }                               
                      }  
                 });  
            }  
