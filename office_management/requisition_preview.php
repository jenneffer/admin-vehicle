                            ...
                            <br>                                          
                                <div class="form-group row col-sm-12">
                                	<div class="col-sm-4">
                                        ...
                                        <div>
                                            ...
                                            db_select ($company, 'company_id', $company_id,'','-select-','form-control','');
                                        ?>
                                    </div>
                                    </div>
                                    <div class="col-sm-4">
                                    	<label for="to" class=" form-control-label"><small class="form-text text-muted">To</small></label>
                                        <input type="text" id="to" name="to" value="<?=$recipient;?>" class="form-control">
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group row col-sm-12">                                	
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" id="serial_no" name="serial_no" value="<?=$serial_no;?>" class="form-control">
                                    </div>
                                	<div class="col-sm-4">
                                        <label for="date" class=" form-control-label"><small class="form-text text-muted">Date</small></label>
                                        <div class="input-group">
                                            <input id="date" name="date" class="form-control" value="<?=$date?>" autocomplete="off">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            <input id="paid_date" name="paid_date" class="form-control" value="<?=$payment_date?>" autocomplete="off">
                                            <div class="input-group-addon"><i class="fas fa-calendar-alt"></i></div>
                                        </div>   
                                    </div>
                                </div>      
                            	...
                            	<div>     
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name='particular[]' size="80" class="form-control-sm hideBorder" value="<?=$data['particular']?>"></td>
                                            <td><input name='total[]' size="20" class="form-control-sm hideBorder text-right" value="<?=number_format($data['total'],2)?>"></td>
                                            <td><input name='remark[]' size="20" class="form-control-sm hideBorder" value="<?=$data['remark']?>"></td>
                                        </tr> 
                                        <?php }?>                                                                     
                                    </table>
                                </div>                                                                                                            
...
//         	    { "width": "10%", "targets": 2 }
        ...
        $('.button_print').on("click", function(event){
            var rq_id = '<?=$rq_id?>';
            event.preventDefault();
            window.open("test.php?rq_id="+rq_id,"mywindow","width=auto,height=auto");
        });
