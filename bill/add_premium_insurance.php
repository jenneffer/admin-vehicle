                            ...
                            <form id="add_premium_insurance" role="form" action="" method="post">
                                <div class="card-body card-block">
                                    <div class="form-group row col-sm-12">                                        	                                          
                                        <div class="col-sm-4">
                                            <label for="date_from" class=" form-control-label"><small class="form-text text-muted">Date From</small></label>                                            
                                            <div class="input-group">
                                                <input id="date_from" name="date_from" class="form-control" autocomplete="off">
                                                <div class="input-group-addon"><i class="fas fa-calendar-alt"></i></div>
                                            </div>  
                                        </div>  
                                        <div class="col-sm-4">
                                            <label for="date_to" class=" form-control-label"><small class="form-text text-muted">Date To</small></label>                                            
                                            <div class="input-group">
                                                <input id="date_to" name="date_to" class="form-control" autocomplete="off">
                                                <div class="input-group-addon"><i class="fas fa-calendar-alt"></i></div>
                                            </div>  
                                        </div> 
                                        <div class="col-sm-4">
