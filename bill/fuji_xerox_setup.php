                   ...
                   <div class="card-body">                                               
					...
					<nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="custom-nav-account-tab" data-toggle="tab" href="#custom-nav-account" role="tab" aria-controls="custom-nav-account" aria-selected="true">Fuji Xerox Account</a>
                            <a class="nav-item nav-link" id="custom-nav-invoice-tab" data-toggle="tab" href="#custom-nav-invoice" role="tab" aria-controls="custom-nav-invoice" aria-selected="false">Invoice</a>
                        </div>
                    </nav> 
                    <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                    	<!-- Fuji Xerox account list -->
                    ...
                    <!-- Invoice list -->
                    <div class="tab-pane fade" id="custom-nav-invoice" role="tabpanel" aria-labelledby="custom-nav-invoice-tab">
...
$(document).ready(function() {
    ...
    $('#add_invoice').on("submit", function(event){  
        ...
        else if($('#company_add').val() == ""){  
            alert("Company is required");  
        }
        else if($('#serial_no_add').val() == ""){  
