<?php 
    ...
    $details_query = "SELECT * FROM bill_management_fee WHERE acc_id = '$acc_id' AND YEAR(payment_date) = '$year_select'";
                            ...
                            <div class="card-body">                                       
                            	...
                            	<form action="" method="post">
                                	<div class="form-group row col-sm-12">           
                                    	...
                                    	<div class="col-sm-4">
                                    		<button type="button" class="btn btn btn-primary button_add" onclick="window.open('management_add_new.php?id=<?=$acc_id?>')">Add New Record</button>
                                    	</div>
                                	</div>
                            	</form>                            	
                            	<div>     
