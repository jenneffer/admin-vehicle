                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Quit Rent Billing</strong>
                            </div>
							<div class="card-body">
                            ...
                            <hr>
                            <div class="card-body">
                                <table id="quit_rent_billing" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                        	<th>Remarks</th>
											<th>INV No.</th>
