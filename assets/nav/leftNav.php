        ...
        <nav class="navbar navbar-expand-sm navbar-default">
			<div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
					<li class="menu-title">VEHICLE</li><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-cogs"></i>Setup</a>
                        <ul class="sub-menu children dropdown-menu">
        					<li><a href="#"><i class="menu-icon fa fa-puzzle-piece"></i>Add Driver </a></li>
                            <li><a href="vehicle_add_new.php"><i class="menu-icon fa fa-id-badge"></i>Add Vehicle </a></li>
                            <li><a href="puspakom_add_new.php"><i class="menu-icon fa fa-bars"></i>Add Puspakom </a></li>
                            <li><a href="roadtax_add_new.php"><i class="menu-icon far fa-credit-card"></i>Add Road Tax </a></li>
                            <li><a href="summon_add_new.php"><i class="menu-icon fa fa-exclamation-triangle"></i>Add Summons</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><a href="vehicle_summons_report.php"><i class="menu-icon fas fa-file-alt"></i></i>Vehicle Summons</a></li>
                            <li><a href="roadtax_summary_report.php"><i class="menu-icon fas fa-book"></i></i>Road Tax Summary</a></li>
